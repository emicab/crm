    ...
    if (sellerId) {
      const fetchData = async () => {
        ...
        try {
          ...
          if (!sellerRes.ok) {
            throw new Error(
              "Vendedor no encontrado o error al cargar sus datos.",
            );
          }
          ...
          if (!salesRes.ok) {
            ...
            throw new Error(
              errorData.message ||
                "Error al cargar el historial de ventas del vendedor.",
            );
          }
    ...
    return (
      <div className="flex flex-col items-center justify-center h-64">
        ...
        <p className="mt-2 text-foreground-muted">
          Cargando historial del vendedor...
        </p>
      </div>
    );
  }
        ...
        {seller && (
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              {seller.email && (
                <p className="text-sm text-foreground-muted">{seller.email}</p>
              )}
            </div>
          </div>
        )}
