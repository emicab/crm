    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={onCancel}>
      <div className="bg-muted text-foreground rounded-lg shadow-xl w-full max-w-md m-4 p-6" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="text-sm text-foreground-muted mb-4">
          Para registrar una venta necesitás tener una caja abierta. Seleccioná el saldo inicial{showVendedores && " y el vendedor"}.
        </p>
        ...
        <div className="flex justify-end gap-2 mt-6">
          ...
          <Button type="button" variant="primary" onClick={() => onOpen(sellerId, initialBalance)} disabled={isOpening || (showVendedores && !sellerId)}>
